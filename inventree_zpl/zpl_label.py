...
class ZPLLabelPlugin(LabelPrintingMixin, SettingsMixin, InvenTreePlugin):
    ...
    SETTINGS = {
        ...
        "TEMPLATES_PATH": {
            "name": _("Label template Path"),
            "description": _("ZPL Jinja2 template directory path"),
            "default": "/home/inventree/data/",
        },
    }
    ...
    def print_label(self, **kwargs):
        ...
        label_instance = kwargs["label_instance"]

        if label_instance.SUBDIR not in ["part", "stockitem", "stocklocation"]:
        ...
        raw_zpl = template.render(label=label).encode("utf-8")
